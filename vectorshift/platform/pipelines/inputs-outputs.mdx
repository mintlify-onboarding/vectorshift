...
The Input and Output nodes are the start and end points of a Pipeline. They can be found within the "Home" section of the Pipeline builder, and they will be shown on the "Run Pipeline" screen whenever a user runs a Pipeline. Input and Output nodes have two fields:
