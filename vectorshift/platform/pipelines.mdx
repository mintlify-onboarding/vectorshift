...
description: "Build custom AI workflows using drag-and-drop nodes."
---
...
1. The "Build" button gives you access to the pipeline builder

2. The "Run" button opens up a "form-like" interface for you to give inputs and receive outputs from the pipeline

3. The "Cost" column gives the cost in credits to running each of the pipelines one time
